  ...
  return (
    <div className="flex h-full flex-col overflow-hidden">
      <header className="flex h-14 shrink-0 items-center gap-3 border-b border-border bg-surface px-6">
        <button onClick={() => navigate({ to: "/admin/matches" })} className="text-mono rounded-sm border border-border bg-surface-2 px-2 py-1 text-xs uppercase tracking-wider hover:bg-muted">← Matches</button>
      ...
      <div className="flex-1 overflow-auto p-6">
        <div className="grid gap-4 md:grid-cols-2">
          <div className="hud-panel p-3">
            <div className="label-eyebrow mb-2 text-xs">VOD link (broadcast)</div>
            <input
          ...
          <div className="hud-panel p-3 md:col-span-2">
            <div className="label-eyebrow mb-2 text-xs">Teams ({matchTeams.length}) · POV VOD links</div>
              ...
              {matchTeams.map((t) => {
                ...
                return (
                  <li key={t.id} className="flex items-center gap-2 rounded-sm border border-border bg-surface px-2 py-1.5 text-xs">
                    ...
                    {url && <span className="max-w-[160px] truncate text-xs text-muted-foreground">{url}</span>}
                    <button
